...
class SeResnet(nn.Module):
    ...
    def __init__(self, block, cfg=None):
        ...
        self.layer1 = self.make_layer(block, self.planes[0], num_blocks[0], cfg=cfg[0:2*sum(num_blocks[0:1])], stride=1, reduction=se_reduction)
...
def test():
    net = create(cfg="../utils/default/cfg_seresnet101.json")
