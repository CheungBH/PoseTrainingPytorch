...
def select_model_cfg(backbone):
    if backbone == "seresnet18":
        return "config/model_cfg/default/cfg_resnet18_3DUC.json"
        ...
        return "config/model_cfg/default/cfg_shuffle_3DUC.json"
    elif backbone == "mobilenet":
        return "config/model_cfg/default/cfg_mobile_3DUC.json"
    else:
